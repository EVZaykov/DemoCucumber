...
public class SignIn_Page extends BasePage {
	public @FindBy(xpath = "//input[@name='login']") WebElement textfield_Username;
	public @FindBy(xpath = "//input[@name='password']") WebElement textfield_Password;
	public @FindBy(xpath = "//input[@value='Sign in']") WebElement button_SignIn;
	public @FindBy(xpath = "//div[contains(@class,'flash-error ')]") WebElement error_Message;
	public @FindBy(xpath = "//h2[text()='Discover interesting projects and people to populate your personal news feed.']") WebElement successful_Login;
